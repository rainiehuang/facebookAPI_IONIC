...
export default class DemofriendCtrl extends Controller {
  constructor($scope) {
    super(...arguments);
...
DemofriendCtrl.$name = 'DemofriendCtrl';
DemofriendCtrl.$inject = ['$state', '$stateParams','$ionicLoading', '$ionicPopup', '$log','AuthService'];